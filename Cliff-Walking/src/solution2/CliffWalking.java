package solution2;// CS394R Assignment 3
...
public class CliffWalking {
    ...
    public static void main(String[] args) {
        // solution2.CliffWalking cw = new solution2.CliffWalking(12, 4);
    ...
    public String etaGreedy(HashMap<String, Double> qa, double eta) {
        ...
        Double oldProb = 0.0;
        //System.out.printf("eV: %f\n gV: %f\nmaxCount: %d\n max: %f\n", exploreProb, greedyProb, maxCount, maxValue);
        for (String action : qa.keySet()) {
            Double currValue = qa.get(action);
